...
class FrequencyAnalyzerSpec extends FunSpec {
  ...
  val dictionary = new java.io.File(
  ...
  describe("A FrequencyAnalyzer object should be able to:") {
    ...
    it("reduce a text to a list of digraphs") {
      ...
      val results = List(
        new KeyCount[String]("HE", 2),
        new KeyCount[String]("TH", 2),
        new KeyCount[String]("ZY", 1),
        new KeyCount[String]("PS", 1),
        new KeyCount[String]("MP", 1),
        new KeyCount[String]("LA", 1),
        new KeyCount[String]("IC", 1),
        new KeyCount[String]("CK", 1),
        new KeyCount[String]("DO", 1),
        new KeyCount[String]("WN", 1),
        new KeyCount[String]("JU", 1),
        new KeyCount[String]("BR", 1),
        new KeyCount[String]("OV", 1),
        new KeyCount[String]("ER", 1),
        new KeyCount[String]("OW", 1),
        new KeyCount[String]("OX", 1),
        new KeyCount[String]("QU", 1),
        new KeyCount[String]("FO", 1),
        new KeyCount[String]("UM", 1),
        new KeyCount[String]("VE", 1),
        new KeyCount[String]("UI", 1),
        new KeyCount[String]("OG", 1),
        new KeyCount[String]("AZ", 1),
        new KeyCount[String]("RO", 1)
      )
    ...
    it("reduce a text to list of mirrored digraphs") {
      assert(
        FrequencyAnalyzer
          .getMirroredKeys(FrequencyAnalyzer.getDigraphKCList(testSentence))
          .size === 0)
      val dkcList = FrequencyAnalyzer.getMirroredKeys(
        FrequencyAnalyzer.getDigraphKCList(testSentence +
          " palindromic digraphs are rare but they often indicate vowels."))

      val result = List(
        new KeyCount[String]("RA", 2),
        new KeyCount[String]("RE", 2),
        new KeyCount[String]("AR", 2),
        new KeyCount[String]("LA", 1),
        new KeyCount[String]("AP", 1),
        new KeyCount[String]("ER", 1),
        new KeyCount[String]("VO", 1),
        new KeyCount[String]("OV", 1),
        new KeyCount[String]("OF", 1),
        new KeyCount[String]("AL", 1),
        new KeyCount[String]("PA", 1),
        new KeyCount[String]("FO", 1)
      )
    ...
    it("reduce a file to a set of digraphs") {
      ...
      assert(
        "List(81094, 77653, 56989, 56529, 54460, 54032, 53704, 51276, 48602, 48468, 47697, " +
    ...
    it("find word in a text with longest consonant grouping") {
      var result = FrequencyAnalyzer
        .getWordList(testSentence)
        .map(x => new KeyCount(x, FrequencyAnalyzer.countUninterruptedConsonants(x)))
    ...
    it("reduce a file to a FrequencyMap of word lengths") {
      ...
      val result = List(
        new KeyCount[Int](9, 62615),
        new KeyCount[Int](8, 62334),
        new KeyCount[Int](10, 54667),
        new KeyCount[Int](7, 53944),
        new KeyCount[Int](11, 46510),
        new KeyCount[Int](6, 41699),
        new KeyCount[Int](12, 37583),
        new KeyCount[Int](13, 27976),
        new KeyCount[Int](5, 25104),
        new KeyCount[Int](14, 19326),
        new KeyCount[Int](4, 13208),
        new KeyCount[Int](15, 12160),
        new KeyCount[Int](16, 7137),
        new KeyCount[Int](3, 6221),
        new KeyCount[Int](17, 4014),
        new KeyCount[Int](18, 2011),
        new KeyCount[Int](2, 1271),
        new KeyCount[Int](19, 1055),
        new KeyCount[Int](20, 508),
        new KeyCount[Int](21, 240),
        new KeyCount[Int](22, 103),
        new KeyCount[Int](1, 53),
        new KeyCount[Int](23, 50),
        new KeyCount[Int](24, 19),
        new KeyCount[Int](25, 9),
        new KeyCount[Int](27, 3),
        new KeyCount[Int](29, 2),
        new KeyCount[Int](26, 2),
        new KeyCount[Int](28, 2),
        new KeyCount[Int](30, 1),
        new KeyCount[Int](31, 1),
        new KeyCount[Int](45, 1)
      )
    ...
    it("extract non-letters and be able to put them back in") {
      ...
      val nonLetterList = FrequencyAnalyzer.extractNonLetterPositionList(text)
      val textLettersOnly =
        FrequencyAnalyzer.dropSpaces(FrequencyAnalyzer.dropNonLettersForceUpper(text))
