...
/**
  ...
  *
  */
class SubstitutionCipherSolver(val plainText: List[String],
  ...
  def computeFrequencyMappedAlphabets(cipherFM: FrequencyMap[Char],
    ...
    val cipherLettersDesc =
      FrequencyAnalyzer.completeLetterList(cipherFM.getKeyList, targetLanguageFM.getKeyList)
